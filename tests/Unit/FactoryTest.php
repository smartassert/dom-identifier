...
namespace SmartAssert\DomIdentifier\Tests\Unit;
...
use SmartAssert\DomIdentifier\Factory;
...
class FactoryTest extends TestCase
{
     ...
     * @return array<mixed>
     */
    public static function attributeIdentifierDataProvider(): array
    {
        return [
     ...
     * @return array<mixed>
     */
    public static function cssSelectorIdentifierDataProvider(): array
    {
        return [
            'css id selector' => [
     ...
     * @return array<mixed>
     */
    public static function descendantIdentifierDataProvider(): array
    {
        return [
            ...
            'great-grandparent >> grandparent >> parent >> child' => [
                'identifierString' => '$".great-grandparent" >> $".grandparent" >> $".parent" >> $".child"',
                'expectedIdentifier' => (new ElementIdentifier('.child'))
                    ->withParentIdentifier(
                        (new ElementIdentifier('.parent'))
                            ->withParentIdentifier(
     ...
     * @return array<mixed>
     */
    public static function xpathExpressionIdentifierDataProvider(): array
    {
        return [
            'xpath id selector' => [
     ...
     * @return array<mixed>
     */
    public static function unknownIdentifierStringDataProvider(): array
    {
        return [
            'empty' => [
                'identifierString' => '',
